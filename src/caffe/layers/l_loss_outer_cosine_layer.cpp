...
void LLossOuterCosineLayer<Dtype>::LayerSetUp(
...
template <typename Dtype>
void LLossOuterCosineLayer<Dtype>::Reshape(
  const vector<Blob<Dtype>*>& bottom, const vector<Blob<Dtype>*>& top) {
...
#ifdef CPU_ONLY
STUB_GPU(LLossOuterCosineLayer);
#endif

INSTANTIATE_CLASS(LLossOuterCosineLayer);
REGISTER_LAYER_CLASS(LLossOuterCosine);
